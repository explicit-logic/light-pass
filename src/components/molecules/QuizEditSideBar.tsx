    ...
    <aside className="fixed left-0 w-64 h-[calc(100vh-58px)] z-40 pt-10 pl-10 transition-transform -translate-x-full md:translate-x-0">
      ...
      <div className="absolute bottom-0 left-0 z-20 w-full flex py-4 px-6">
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? 'text-center inline-flex items-center rounded-lg bg-gray-100 dark:text-gray-200 dark:bg-gray-700 text-gray-600 focus:outline-none font-medium text-sm px-3 py-2.5'
              : 'text-center inline-flex items-center text-gray-600 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-3 py-2.5 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-700 dark:focus:ring-gray-700'
          }
          end
        >

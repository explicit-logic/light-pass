  ...
  return (
    <div className="mt-6 w-full">
      ...
      <div className="flex flex-row justify-center m-auto max-w-lg mt-4">
        ...
        <button
          type="button"
          className="inline-flex items-center text-white bg-gradient-to-br from-purple-600 to-blue-500 enabled:hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 disabled:opacity-30"
          disabled
          // onClick={openBuilder}
        >
          <svg
